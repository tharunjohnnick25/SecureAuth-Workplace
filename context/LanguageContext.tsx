...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    CompleteYourDetailsDesc: 'Your account requires a few mandatory details before you can access your workspace.',
    MandatoryStep: 'Mandatory step before first login',
    ...
    saveDetailsNote: 'These details are required for security and emergency purposes.',
    employeeLoginTitle: 'Employee Login',
    employeeLoginDesc: 'Log in to access your secure workplace environment.',
    companyLabel: 'Select Company',
    selectRegisteredCompany: 'Select your registered company',
    employeeEmailLabel: 'Work Email',
    emailLabel: 'Email Address',
    passwordLabel: 'Password',
    companyDetected: 'Detected',
    adminLoginTitle: 'Admin Login',
    adminLoginDesc: 'Sign in to access the enterprise administration console.',
