...
function genSelenium() {
  ...
  const land = [
    ...
    ["Verify 'Get Started' CTA navigates to /signup page on click","Landing page loaded","1. Locate main CTA button\n2. Click button\n3. Wait for route change\n4. Assert URL is /signup","CTA button click event","Browser navigates to http://localhost:3000/signup"],
