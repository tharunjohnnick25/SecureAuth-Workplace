...
- Name: rbac.spec.ts >> RBAC End-to-End Tests >> Admin can access the user management panel
- Location: e2e\rbac.spec.ts:19:7
...
Locator: getByRole('heading', { name: /Access Management/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Access Management/i })
